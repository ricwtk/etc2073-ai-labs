...
<div class="timeline">
    ...
    <div class="container right">
        <div class="date">Session 4</div>
        <div class="content"><a href="./lab4-decision-tree/">Lab 4 Decision Tree</a></div>
    </div>
    <div class="container right">
        <div class="date">Session 5</div>
        <div class="content"><a href="./lab5-clustering/">Lab 4 Clustering</a></div>
    </div>
</div>
